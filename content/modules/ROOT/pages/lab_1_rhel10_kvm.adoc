...
* Scroll down untill you see the **Red Hat Enterprise Linux 10.0 KVM Guest Image**,
...
[source,ini,role=execute,subs=attributes+]
----
sudo mv ~/Downloads/rhel-10.0-x86_64-kvm.qcow2 /var/lib/libvirt/images/rhel-10.0-x86_64-kvm.qcow2
----
...
[source,ini,role=execute,subs=attributes+]
----
sudo cp /var/lib/libvirt/images/rhel-10.0-x86_64-kvm.qcow2 /var/lib/libvirt/images/bastion-rhel-10.0-x86_64-kvm.qcow2
----
...
[source,ini,role=execute,subs=attributes+]
----
sudo cp /var/lib/libvirt/images/rhel-10.0-x86_64-kvm.qcow2 /var/lib/libvirt/images/node1-rhel-10.0-x86_64-kvm.qcow2
----
...
[source,ini,role=execute,subs=attributes+]
----
sudo virt-customize -a /var/lib/libvirt/images/bastion-rhel-10.0-x86_64-kvm.qcow2 --root-password password:MySecurePassphrasefor2024 --uninstall cloud-init

sudo virt-customize -a /var/lib/libvirt/images/node1-rhel-10.0-x86_64-kvm.qcow2 --root-password password:MySecurePassphrasefor2024 --uninstall cloud-init
----
...
*** On the Disk image we want to use this path **/var/lib/libvirt/images/bastion-rhel-10.0-x86_64-kvm.qcow2**
...
*** On the Connections option we want to make sure that **System** is selected
*** On the Disk image we want to use this path **/var/lib/libvirt/images/node1-rhel-10.0-x86_64-kvm.qcow2**
